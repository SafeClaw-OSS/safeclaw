...
- **Use these services proactively.** When the user asks you to do something a connected service can handle, call its API through the proxy. You have full access — don't wait to be told about SafeClaw.
